...
namespace Anter.Win32.JL.DSSaveTools
{
	...
	public class frmMain : System.Windows.Forms.Form
	{
		...
		private void LanguageText() 
		{
			...
			strLanguageForm[12] = new string[]{"输出格式","輸齣格式","Type"};   //lblOutputFormat
			strLanguageForm[13] = new string[]{"输出大小","輸齣大小","Size"};   //lblOutputSize
		...
		private void SetCardType() 
		{
			...
			//以下是NDS烧录卡列表
			SetupCardType[0][0] = new CardType(0,"Acekard+ & Acekard RPG","AK","1110110000",4,0,".nds.sav",0,"slot1接口，使用外置TF卡和内置(RPG专有)存储，标准存档格式，需选择大小。");
			SetupCardType[0][1] = new CardType(0,"Acekard 2","AK2","0000010000",1,0,".sav",0,"slot1接口，使用外置TF卡存储，标准512K存档格式。 ");
			SetupCardType[0][2] = new CardType(0,"CycloDS Evolution","CyDS","0000010000",1,0,".sav",0,"slot1接口，使用外置TF卡存储，标准512K存档格式。  ");
			SetupCardType[0][3] = new CardType(0,"DS FIRE LINK","DSFLK","0000100000",1,1,".sav",0,"DSGBA OEM产品，slot1+2接口，使用内置存储芯片，标准256K存档格式。");
			SetupCardType[0][4] = new CardType(0,"DSGBA","DSGBA","0000100000",1,1,".sav",0,"slot1+2接口，使用内置存储芯片，标准256K存档格式。");
			SetupCardType[0][5] = new CardType(0,"DSLink","DSLK","0000010000",1,0,".sav",2,"slot1接口，使用内置存储芯片，固定的520K特有存档格式。");
			SetupCardType[0][6] = new CardType(0,"DSTT (Top Toy)","DSTT","0000010000",1,0,".sav",0,"slot1接口，使用外置TF卡存储，标准512K存档格式。");
			SetupCardType[0][7] = new CardType(0,"DS-Xtreme 4Gb/16Gb","DSXr","0000100000",1,1,".sav",0,"slot1接口，内置存储，标准256K存档格式。");
			SetupCardType[0][8] = new CardType(0,"EDGE","EDGE","0000010000",1,0,".sav",0,"slot1接口，使用外置TF卡存储，标准512K存档格式。 ");
			SetupCardType[0][9] = new CardType(0,"EWIN2","EW2","0000110000",2,1,".sav",0,"slot2接口，使用内置存储芯片，标准存档格式，新版本体积512K，旧版本体积为256K。");
			SetupCardType[0][10] = new CardType(0,"EZ Flash 4","EZ4","0000100000",1,1,".sav",0,"slot2接口，使用内置存储芯片，256K标准存档格式。");
			SetupCardType[0][11] = new CardType(0,"EZ Flash 5","EZ5","1110110000",4,0,".sav",0,"slot1接口，使用外置TF卡存储，标准存档格式，需选择大小。");
			SetupCardType[0][12] = new CardType(0,"G6 (Lite)","G6","0000110000",1,0,".0",0,"信息添加中……");
			SetupCardType[0][13] = new CardType(0,"G6 DS Real","G6DSR","0000010000",1,0,".sav",0,"信息添加中……");
			SetupCardType[0][14] = new CardType(0,"M3 (Lite)","M3","0000110000",1,0,".dat",1,"信息添加中……");
			SetupCardType[0][15] = new CardType(0,"M3 DS Real","M3DSR","0000010000",1,0,".sav",0,"信息添加中……");
			SetupCardType[0][16] = new CardType(0,"M3 DS Simply","M3DSS","0000010000",1,0,".sav",0,"信息添加中……  ");
			SetupCardType[0][17] = new CardType(0,"MK5","MK5","0000100000",1,1,".sav",0,"DSGBA OEM产品，slot1+2接口，使用内置存储芯片，标准256K存档格式。");
			SetupCardType[0][18] = new CardType(0,"N-CARD","NCARD","0000100000",1,1,".sav",0,"DSGBA OEM产品，slot1+2接口，使用内置存储芯片，标准256K存档格式。");
			SetupCardType[0][19] = new CardType(0,"NinjaDS","NjaDS","0000010000",1,0,".sav",0,"slot1接口，标准512K存档格式。 ");
			SetupCardType[0][20] = new CardType(0,"NinjaPass","NjaPa","0000100000",1,1,".sav",0,"slot1接口，标准256K存档格式。 ");
			SetupCardType[0][21] = new CardType(0,"R4","R4","0000010000",1,0,".sav",0,"slot1接口，使用外置TF卡存储，标准512K存档格式。 ");
			SetupCardType[0][22] = new CardType(0,"Super Card (Lite)","SC","0000100000",1,1,".nds.sav",0,"信息添加中……  ");
			SetupCardType[0][23] = new CardType(0,"Super Card DS (ONE)","SCDS","1110110000",4,0,".sav",0,"信息添加中……");
			SetupCardType[0][24] = new CardType(0,"SUNNY FLASH","SYFH","0000100000",1,1,".sav",0,"DSGBA OEM产品，slot1+2接口，使用内置存储芯片，标准256K存档格式。");
			SetupCardType[0][25] = new CardType(0,"(EMU) NO$GBA (Raw)","NO$GBA","0000010000",1,0,".sav",0,"信息添加中……");
			SetupCardType[0][26] = new CardType(0,"Normal 512K","512K","0000010000",1,0,".sav",0,"通用的512K存档格式，大多数新烧录卡使用这种格式。");
			SetupCardType[0][27] = new CardType(0,"Other (All Sizes)","OTHER","1111111000",5,1,".sav",0,"信息添加中……");


			//以下是GBA烧录卡列表
			SetupCardType[1][0] = new CardType(1,"EZ 3IN1","3IN1","0001000000",1,0,".sav",0,"slot2接口，使用内置存储芯片，标准存档格式。");
			SetupCardType[1][1] = new CardType(1,"Elink (Lite)","Elink","1111000000",3,0,".sav",0,"slot2接口，使用内置存储芯片，标准存档格式。");
			SetupCardType[1][2] = new CardType(1,"EZ4","EZ4","0001000000",1,0,".sav",0,"slot2接口，使用内置存储芯片，标准存档格式。");
			SetupCardType[1][3] = new CardType(1,"G6 (Lite)","G6","0001000000",1,0,".0",0,"slot2接口，使用内置存储芯片，标准存档格式。");
			SetupCardType[1][4] = new CardType(1,"GBA Expansion Pack","GBAEP","0001000000",1,0,".0",0,"slot2接口，使用内置存储芯片，标准存档格式。");
			SetupCardType[1][5] = new CardType(1,"M3 (Lite)","M3","0001001000",1,0,".dat",1,"slot2接口，使用外置SD或SD mini卡，129K特殊存档格式。");
			SetupCardType[1][6] = new CardType(1,"Super Card (Lite)","SC","0001000000",1,0,".nds.sav",0,"slot2接口，使用外置SD或SD mini卡，标准存档格式。");
			SetupCardType[1][7] = new CardType(1,"Other (All Sizes)","OTHER","1111111000",4,0,".sav",0,"未知存储卡，仅支持标准存档格式。");
